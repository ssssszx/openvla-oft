...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def _regression_prediction_revip(self,
        input_embeddings,
        all_actions_mask,
        projected_patch_embeddings,
        attention_mask,
    ...
    def _prepare_action_prediction_embeddings(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        # unnorm_key: Optional[str] = None,
        # proprio=None,
        ...
        **kwargs: str,
        ...
        """Prepare embeddings needed for action prediction.
    ...
    def _predict_action_from_embeddings(
        self,
        *,
        ...
        """Predict actions from precomputed embeddings."""
        # Add proprioceptive features if provided
        use_proprio = proprio_projector is not None and proprio is not None
        if use_proprio:
        ...
        if use_diffusion:
            ...
            if not train:
                ...
                normalized_actions, actions_hidden_states = self._regression_or_discrete_prediction_train(
                    input_embeddings,
                    all_actions_mask,
                    projected_patch_embeddings,
                    attention_mask,
        ...
        # print("type:", type(normalized_actions))
        # print("dtype:", normalized_actions.dtype)
        # print("requires_grad:", normalized_actions.requires_grad)
        # print("grad_fn:", normalized_actions.grad_fn)   
        # 
